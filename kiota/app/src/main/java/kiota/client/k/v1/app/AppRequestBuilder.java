package kiota.client.k.v1.app;

import com.microsoft.kiota.BaseRequestBuilder;
import com.microsoft.kiota.RequestAdapter;
import java.util.HashMap;
import java.util.Objects;
import kiota.client.k.v1.app.adminnotesjson.AdminNotesJsonRequestBuilder;
import kiota.client.k.v1.app.settingsjson.SettingsJsonRequestBuilder;
/**
 * Builds and executes requests for operations under /k/v1/app
 */
...
public class AppRequestBuilder extends BaseRequestBuilder {
    ...
    /**
     * The settingsJson property
     * @return a {@link SettingsJsonRequestBuilder}
     */
    @jakarta.annotation.Nonnull
    public SettingsJsonRequestBuilder settingsJson() {
        return new SettingsJsonRequestBuilder(pathParameters, requestAdapter);
    }
    /**
    ...
    public AppRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/k/v1/app", pathParameters);
    }
    /**
     * Instantiates a new {@link AppRequestBuilder} and sets the default values.
    ...
    public AppRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/k/v1/app", rawUrl);
    }
}
