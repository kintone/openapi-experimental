...
public class DeployPostResponseApps implements AdditionalDataHolder, Parsable {
    /**
    ...
    /**
     * Instantiates a new {@link DeployPostResponseApps} and sets the default values.
     */
    public DeployPostResponseApps() {
        this.setAdditionalData(new HashMap<>());
    }
    /**
     * Creates a new instance of the appropriate class based on discriminator value
     * @param parseNode The parse node to use to read the discriminator value and create the object
     * @return a {@link DeployPostResponseApps}
     */
    @jakarta.annotation.Nonnull
    public static DeployPostResponseApps createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new DeployPostResponseApps();
    }
    /**
