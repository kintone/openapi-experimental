...
public class UpdateAppAdminNotesResponse implements AdditionalDataHolder, Parsable {
    /**
    ...
    /**
     * Instantiates a new {@link UpdateAppAdminNotesResponse} and sets the default values.
     */
    public UpdateAppAdminNotesResponse() {
    ...
    public static UpdateAppAdminNotesResponse createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new UpdateAppAdminNotesResponse();
    }
    /**
